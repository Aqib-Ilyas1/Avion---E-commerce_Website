...
const FeaturesAdditional = () => {
    return (
        <main>
            <div className="p-8 flex flex-col gap-5 medium:flex-row medium:gap-1.5 medium:px-28">
                <div className="bg-[#2A254B] p-6 flex flex-col gap-7 medium:flex-1 medium:p-16">
                    ...
                    <button className="satoshiFont text-white text-base bg-[#c8c7cf3a] px-4 py-2 medium:w-fit medium:mt-[120px]">
                        View collection
                    </button>
